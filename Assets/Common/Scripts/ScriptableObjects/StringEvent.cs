...
/// <summary>
/// StringEvent - A simple observer pattern implementation using ScriptableObject.
/// </summary>
...
public class StringEvent : ScriptableObjectBase
{
	...
	/// <summary>
	/// Raises the event with the specified string value.
	/// </summary>
	/// <param name="value">The string value to pass to subscribers.</param>
